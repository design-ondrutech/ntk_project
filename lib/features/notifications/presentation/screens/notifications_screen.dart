        ...
        child: Column(
          ...
          children: [
            ...
            SingleChildScrollView(
              ...
              child: Row(
                children: [
                  _buildFilterPill('All Notifications', isSelected: true),
                  const SizedBox(width: 12),
                  _buildFilterPill('Events'),
                  const SizedBox(width: 12),
                  _buildFilterPill('Requests'),
                ],
              ),
            ),
            ...
            _buildNotificationCard(
              ...
              iconColor: const Color(0xFF007B3E),
              hasActions: true,
            ),
            const SizedBox(height: 16),
            _buildNotificationCard(
  ...
  Widget _buildFilterPill(String label, {bool isSelected = false}) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: isSelected ? const Color(0xFF007B3E) : const Color(0xFFEFF6FF),
